...
class TranslationPdf {
    ...
    public Cell ValueCell{
        get{
            ...
            Text text = TextElementFactory.Generare(_translation.Value, Fonts.Medium, FontSize.AccentText2, _colorTheme.MainText);
    ...
    public Cell CommentCell{
        get{
            ...
            paragraph.Add(TextElementFactory.Generare(_translation.Comment, Fonts.Medium, FontSize.SubText2, _colorTheme.MainText));
            cell.Add(paragraph);   
